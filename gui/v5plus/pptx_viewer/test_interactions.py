#!/usr/bin/env python3
"""pptx-renderer 交互能力验证 - 测试在渲染 DOM 上叠加选择/拖拽/编辑"""
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("pptx-renderer 交互验证")
        ...
        page.setUrl(QUrl(f"http://127.0.0.1:{HTTP_PORT}/test_interactions.html"))
...
if __name__ == "__main__":
    ...
    print("窗口已打开，请在右侧测试：")
    print("  1. 鼠标悬停 → 蓝色虚线高亮")
    print("  2. 点击元素 → 蓝色实线选中，右侧显示属性")
    print("  3. 切换到✋拖拽模式 → 拖动元素")
    print("  4. 切换到✏编辑模式 → 双击文字编辑")
